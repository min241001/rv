...
import com.renny.contractgridview.base.DateUtils;
...
public class VerticalOverlayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemEventListener {
    ...
    private ItemEventListener.OnItemClickListener onItemClickListener;
        ...
        {//普通类型ViewHolder
            ...
            if (beans.get(position).getType() != -1) {
                try {
                    ...
                    viewHolder.app_icon.setImageDrawable(AppUtil.getAppIcon(context, beans.get(position).getPackage_name()));
