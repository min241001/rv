...
import com.renny.contractgridview.utils.ImageUtil;
import com.renny.contractgridview.utils.ScreenUtil;
...
public class CircleProgress extends View
{
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        default_text_size = ScreenUtil.spToPx(getResources(), 18);
        min_size = (int)ScreenUtil.spToPx(getResources(), 100);
        default_stroke_width = ScreenUtil.spToPx(getResources(), 10);
        default_inner_bottom_text_size = ScreenUtil.spToPx(getResources(), 18);
    ...
    protected void initInnerBitmap(Context context)
    {
        ...
        {
            bitmap = ImageUtil.getBitmap(context, attributeResourceId);
        }
    }
