...
public class AppUtils {
    ...
    public static List<AppInfoBean> getAllAppInfo(Context context, Handler handler, boolean isFilterSystem) {
        try {
    ...
    public static void InitData(Context context, Handler handler) {
        try {
            ...
            for (int i = 0; i < packages.size(); i++) {
                ...
                if ((packageInfo.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM) == 0 || (packageInfo.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM) == 1) {
