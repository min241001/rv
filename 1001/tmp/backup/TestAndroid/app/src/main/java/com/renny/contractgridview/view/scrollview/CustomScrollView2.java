...
public class CustomScrollView2 extends NestedScrollView {
    ...
    public CustomScrollView2(@NonNull Context context) {
        super(context);
    }
    ...
    private float mSlop;
    public CustomScrollView2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomScrollView2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
