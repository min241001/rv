...
public class DemoView<T extends Adapter> extends AdapterView<T> {
    ...
    private static final int SCROLL_RANGE_X = 30;
    private static final int SCROLL_RANGE_Y = 10;
...
//                scrollContainer(x, y, minx, miny);
    ...
    private void scrollContainer(int x, int y, int flag) {
        ...
        if (scrollMoveX < -300 || scrollMoveY < -300 || scrollMoveX > 300 || scrollMoveY > 300) {
            endTouch();
            return;
        }
