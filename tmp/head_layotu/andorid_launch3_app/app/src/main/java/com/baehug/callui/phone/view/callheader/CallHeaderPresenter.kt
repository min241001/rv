...
import com.baehug.callui.base.BasePresenter
import com.baehug.callui.phone.bean.PhoneMsg
import com.baehug.callui.phone.manager.ContactManager
import com.baehug.callui.phone.manager.PhoneNumberManager
...
class CallHeaderPresenter(view: CallHeaderContract.View) : BasePresenter<CallHeaderContract.View>(), CallHeaderContract.Presenter {
    ...
    override fun queryLocalContactInfo(context: Context, phoneNum: String) {
        ContactManager.getContentCallLog(context, phoneNum, object : ContactManager.Callback{
            override fun onFinish(contentCallLog: ContactUtil.ContactInfo?) {
                mView.onQueryLocalContactInfoSuccessful(contentCallLog)
            }
