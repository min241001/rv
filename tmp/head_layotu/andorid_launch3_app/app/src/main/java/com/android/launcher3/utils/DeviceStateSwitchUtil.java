...
public class DeviceStateSwitchUtil {
    ...
    public static void main(String[] args) {
        ...
        String test2 = DeviceStateSwitchUtil.getHexString(DeviceStateSwitchUtil.DeviceStateConstant.FALL_DOWN_ALERT,DeviceStateSwitchUtil.DeviceStateConstant.WATCH_MOVING);
        Boolean ifFallDown = DeviceStateSwitchUtil.checkDeviceStateByHexString(DeviceStateSwitchUtil.DeviceStateConstant.FALL_DOWN_ALERT,test2);
