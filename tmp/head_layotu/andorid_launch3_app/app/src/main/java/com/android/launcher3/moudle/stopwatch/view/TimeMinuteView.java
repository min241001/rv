...
public class TimeMinuteView extends View {
    ...
    public TimeMinuteView(Context context) {
        super(context);
        this.mContext = context;
        initPainter();
    }

    public TimeMinuteView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        init(context, attrs);
        initPainter();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isDrawText) {
            ...
            for (int i = 0; i < 6; i++) {
                if (i == 0) {
                    drawNum(canvas, i * 60, 30 + "", mPaint);
                } else {
                    drawNum(canvas, i * 60, i * 5 + "", mPaint);
                }
            }
            canvas.restore();
        }
...
//            mHourDegree = min * 0.5f + hour * 30f;
        ...
        mMinDegree = (min + second * 1.0f / 60f) * 12f;
