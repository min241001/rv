...
public final class CalendarUtil {
   ...
   //获取上一个日子
    public static Calendar getPreCalendar(Calendar calendar) {
        ...
        long timeMills = date.getTimeInMillis();
    ...
    public static int differ(Calendar calendar1, Calendar calendar2) {
        ...
        long startTimeMills = date.getTimeInMillis();
    ...
    static List<Calendar> initCalendarForMonthView(int year, int month, Calendar currentDate, int weekStar) {
        ...
        //获取月视图其实偏移量
        int mPreDiff = getMonthViewStartDiff(year, month, weekStar);
        //获取月份真实天数
    ...
    public static String getMonthTetx(Context context, int position,@ArrayRes int id){
    ...
    public static String getWeekTetx(Context context, int position){
        String[] array = context.getResources().getStringArray(R.array.week);
        return array[position];
    }

    public static String getDayTetx(Context context, int position){
        String[] array = context.getResources().getStringArray(R.array.lunar_str);
        return array[position - 1];
    }
}
