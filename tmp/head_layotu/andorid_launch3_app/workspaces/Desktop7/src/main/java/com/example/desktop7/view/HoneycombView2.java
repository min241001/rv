 ...
 */
public class HoneycombView2<T extends Adapter> extends AdapterView<T> {

    private static final String TAG = "HoneycombView2";
    private T mAdapter;
    public int lastX;
    public int mDownX;
    public int lastY;
    ...
    public HoneycombView2(Context context) {
        super(context);
        init(context);
    }

    public HoneycombView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public HoneycombView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void positionItems() {
        for (int index = 0; index < getChildCount(); index++) {
            if (mAdapter.getItemId(index) != menu_index) {
                ...
                int offsetY = mScreenH - (int) (mItemSize * 2);
                //child.layout((int) xy.x + offsetX, (int) xy.y + offsetY, (int) xy.x + offsetX + width, (int) xy.y + offsetY + height);
    ...
    private void init(Context context) {
        ...
        mCenterH = this.mScreenH / 2-menu_h;
