package com.android.launcher3.desktop6.cutomlayoutmanager;
...
import com.android.launcher3.desktop6.R;
import com.android.launcher3.desktop6.cutomlayoutmanager.keyframes.Keyframes;
import com.android.launcher3.desktop6.cutomlayoutmanager.keyframes.PosTan;
...
public class PathLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private static final String TAG = "PathLayoutManager_123123";
...
//            Log.e("Angle", "角度=====" + tmp.getChildAngle() + 90f);
//            Log.e("Index", "位置=====" + tmp.index);
//            Log.e("fraction:", "百分比=====" + tmp.fraction);
//            Log.e("========", "==================");

            if (tmp.fraction < 0.12 || tmp.fraction > 0.88) {
                item.findViewById(R.id.app_name).setVisibility(View.GONE);
            } else {
                item.findViewById(R.id.app_name).setVisibility(View.VISIBLE);
            }
