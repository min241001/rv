...
public class RepairedItemAnimator extends SimpleItemAnimator {
    ...
    private final static String TAG = "RepairedItemAnimator_123123";
    ...
    public boolean animateDisappearance(RecyclerView.ViewHolder viewHolder, ItemHolderInfo preLayoutInfo, ItemHolderInfo postLayoutInfo) {
        // 根据viewHolder的位置决定是否显示动画
        Log.i(TAG, "animateDisappearance: left " + preLayoutInfo.left + " right " + preLayoutInfo.right);
        return false;
    }
