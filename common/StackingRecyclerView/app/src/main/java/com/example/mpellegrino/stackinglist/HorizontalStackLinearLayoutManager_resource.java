 ...
 */
public class HorizontalStackLinearLayoutManager_resource extends LinearLayoutManager {
     ...
     */
    public HorizontalStackLinearLayoutManager_resource(Context context, @NonNull HorizontalStackLinearConfig stackConfig, boolean stackFromEnd) {
