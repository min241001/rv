...
public class FileUtil {
    ...
    private static String rootPath = "XmRecord";
    //原始文件(不能播放)
    ...
    public static boolean fileRename(String name, String newName) {
        LogUtil.i("fileRename: name " + name + ", newName " + newName, LogUtil.TYPE_RELEASE);
        // 原始文件路径和新文件名
        try {
            ...
            LogUtil.i("fileRename: renamed " + renamed, LogUtil.TYPE_RELEASE);
            return renamed;
        } catch (Exception e) {
            e.printStackTrace();
            LogUtil.e("FileUtil", "fileRename: ", e, LogUtil.TYPE_RELEASE);
        }
        return false;
    }
    ...
    public static boolean deleteFile(String name) {
        try {
            ...
            if (file.exists()) {
                ...
                LogUtil.i("deleteFile: deleted " + deleted + " name " + name, LogUtil.TYPE_RELEASE);
                return deleted;
            } else {
                LogUtil.i("deleteFile: 文件不存在 ", LogUtil.TYPE_RELEASE);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
