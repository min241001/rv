package com.android.launcher3.moudle.heartrate.view;
...
import com.android.launcher3.moudle.heartrate.presenter.HeartRatePresenter;
...
public class HeartRateActivity extends BaseMvpActivity<HeartRateView, HeartRatePresenter> implements HeartRateView, OnChartValueSelectedListener {
    ...
    protected void initData() {
        ...
        if (isWear) {
            ...
            View view = View.inflate(this, com.android.launcher3.common.R.layout.dialog_fall_heart_hint, null);
    ...
    private void setData(int count, float range) {
        ...
        if (barChart.getData() != null &&
            ...
            for (int i = 0; i <= values.size() - 1; i++) {
                ...
                if (values.get(i).getY() <= 60f) {
                    set1.getColors().add(getResources().getColor(com.android.launcher3.common.R.color.blood_oxygen_green, null));
                } else if (values.get(i).getY() > 60f && (int) values.get(i).getY() < 90f) {
