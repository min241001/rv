...
public class AppLocalData {
    ...
    //获取设置中float开关状态
    //广播actioon com.baehug.setting.menu 参数 1打开 关闭 0
    public int getMenuFloatOpenState() {
        return Settings.System.getInt(contentResolver, SettingsConstant.LS_FLOAT_MENU_MODE, 0);
    }
