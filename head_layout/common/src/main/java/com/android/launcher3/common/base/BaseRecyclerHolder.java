...
public class BaseRecyclerHolder extends RecyclerView.ViewHolder {
     ...
     * 设置图片
     */
    public BaseRecyclerHolder setImageResource(int viewId,@DrawableRes int drawableId){
     ...
     * 设置图片
     */
    public BaseRecyclerHolder setImageDrawable(int viewId, @Nullable Drawable drawable){
        ImageView iv = getView(viewId);
     ...
     * 设置图片
     */
    public BaseRecyclerHolder setTextImageDrawable(int viewId, @Nullable Drawable drawable,CharSequence text){
