...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerHolder> {
    ...
    private OnTouchListener onTouchListener;//触摸监听
    private RecyclerView recyclerView;

    public int getSize(int dp) {
        return ScreenUtil.dpToPx(getResources(), dp);
    }
    ...
    public interface OnTouchListener {
        boolean onTouch(RecyclerView parent, View view, int position, MotionEvent motionEvent);
    }
...
//        }
        ...
        holder.itemView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (onTouchListener != null && view != null && recyclerView != null) {
                    int position = recyclerView.getChildAdapterPosition(view);
                    onTouchListener.onTouch(recyclerView, view, position, motionEvent);
                    return true;
                }
                return false;
            }
